...
//Posts a CLM event and checks if the event is received succesfully with valid auth-token
...
test("Test id: 52 for QR2", async () => {
  let eiffelDataObj = {
    meta: {
      type: "EiffelArtifactCreatedEvent",
      version: "3.0.0",
      time: 1234567890,
      id: "3fbfa511-2f7f-4d77-9302-8e06779e73a2",
      source: {
...
//Posts a CLM event and checks if the event is rejected succesfully with invalid auth-token

test("Test id: 53 for QR2", async () => {
  let auth_token = "";
  let eiffelDataObj = {
    meta: {
      type: "EiffelArtifactCreatedEvent",
      version: "3.0.0",
      time: 1234567890,
      id: "09373728-f1bd-4163-b2a2-f9c610e88a26",
      source: {
        serializer: "pkg:maven/com.mycompany.tools/eiffel-serializer@1.0.3"
      },
      tags: ["fast-track", "customer-a"]
  ...
  let config = {
    headers: { "auth-token": "lkmaslksflkmfasasdasdasdasd" }
  };
  await Axios.post(
    "http://localhost:9000/submitevent",
    { eiffelDataObj, parameterObj },
